...
export const GET: APIRoute = async () => {
  ...
  //Hero roster and its build + guide pages — bounded curated families off the same roster.
  //No lastmod on any of the three: their numbers refresh on every data_version build, on no
  //date the front matter knows. Build-ahead: empty on a cold API, so none is advertised yet.
