---
title: "Souls economy basics: stop losing the game in the first ten minutes"
...
A denied soul is worth double: you gain tempo and your opponent loses income.
Watch the wave; if you cannot secure a last-hit, deny it instead. Over a full
game this is worth an entire item.

## The minute-by-minute habit

Set a mental checkpoint every four minutes:

- Am I within 500 souls of my expected curve?
- Is there an uncontested camp I am ignoring?
- Did I die for less than I would have farmed standing still?

Answer those honestly and your souls-per-minute climbs on its own. The numbers in
this guide track the live meta, so the breakpoints stay current patch to patch.
