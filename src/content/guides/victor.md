---
title: "Victor guide: the damage you take is the damage you deal"
description: "Play Victor as the hero who wants to be hit. When to hold Pain Battery, why Jumpstart is a farming button, and what to do with a hero whose worst matchup on the whole roster is 49.7%."
hero: Victor
heroSlug: victor
heroId: 66
...
counters: [Seven, Kelvin, Graves, Ivy, McGinnis]
synergyItems: [Spirit Burn, Scourge, Mystic Reverb, Refresher, Transcendent Cooldown]
buildIds: [390855, 376853, 301983, 308507, 411712]
sources:
  - https://dramalock.org/guides/victor-deadlock-guide-build-abilities/
  - https://api.ranklock.app/heroes/66/matchups
  - https://api.ranklock.app/heroes/66/counters
  - https://api.ranklock.app/heroes/66/item-win-rates
heroImage: "https://assets-bucket.deadlock-api.com/assets-api-res/images/heroes/frank_card.png"
liveHeroes: [Victor, Seven, Graves, Lash]
liveItems: [Spirit Burn, Scourge, Mystic Reverb, Refresher, Transcendent Cooldown]
---

## Who plays Victor, and why

Walk into the brawl on purpose, and stay in it a beat longer than feels right. Victor's whole kit converts incoming damage into outgoing damage, and the numbers agree with the instinct: he wins 54.1% of games settled inside 30 minutes, 57.1% of those running 30 to 45 and 57.7% past 45, a rise of 3.6 that starts from a figure most heroes never reach at any length.

He has no losing matchup on his table. The closest anyone comes is Seven at 49.7% over 396,201 games, then Kelvin at 50.9% over 159,840 and Graves at 51.1% over 329,833. On 800 HP at 6.3 m/s with 3 stamina he is the slowest hero in this batch, which is fine, because the plan was never to leave.
...
Then the item table, which is the most emphatic in this batch. Spirit Burn reads 67.5% across 471,952 games on him, Scourge 66.4% over 1,421,080, Mystic Reverb 65.8% over 243,004 and Witchmail 65.1% over 730,445. Transcendent Cooldown at 63.6% over 2,907,836 games and Boundless Spirit at 63.0% over 2,441,064 are the two largest samples on the page, and both hold their rate across those tables.
...
He also has the only real duos in this batch. Lash reads 57.8% over 22,622 games beside him, Rem 54.8% over 21,751 and Bebop 53.6% over 23,037, so a teammate who can hold the enemy in one place is worth drafting for.
