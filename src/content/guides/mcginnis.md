---
title: "McGinnis guide: build the ground, then make them come to it"
description: "Play McGinnis as the hero who decides where the fight happens before it starts. Where Spectral Wall goes, the item that lets Heavy Barrage finish, and the lane that is harder than the matchup table admits."
hero: McGinnis
heroSlug: mcginnis
heroId: 8
...
roles: [support, offensive]
counters: [Seven, Victor, Graves, Paige, Kelvin]
synergyItems: [Spirit Burn, Healing Tempo, Unstoppable, Boundless Spirit, Refresher]
buildIds: [203289, 371708, 583067, 1111, 1206]
sources:
  - https://dramalock.org/guides/mcginnis-deadlock-guide-build-abilities/
  - https://api.ranklock.app/heroes/8/matchups
  - https://api.ranklock.app/heroes/8/item-win-rates
heroImage: "https://assets-bucket.deadlock-api.com/assets-api-res/images/heroes/engineer_card.png"
liveHeroes: [McGinnis, Seven, Victor, Graves]
liveItems: [Spirit Burn, Healing Tempo, Unstoppable, Boundless Spirit, Refresher]
---

## Who plays McGinnis, and why

Take McGinnis when your team needs a position it can hold and nobody else will hold it, and accept up front that you are the slowest hero in the fight. She carries 780 HP at 6.7 m/s with only 2 stamina, and her numbers lean early: 52.3% win rate under 30 minutes, 50.6% from 30 to 45 and 49.7% past 45.

The kit is four things you place and then defend. Mini Turret drops a turret that deals spirit damage until it expires. Medicinal Specter leaves behind a spirit that heals whoever stands beside it. Spectral Wall is a slowing wall you can erupt to split terrain and damage whatever stands on it. Heavy Barrage marks a spot and calls a homing rocket volley onto it, and she is slowed while it fires.
...
Heroic Aura is her signature support purchase at 6.0 times the roster average, with Mystic Slow behind it at 4.2. Everything she buys either extends her ground or slows the people crossing it.
...
Spectral Wall first on four of the five lists; the exception, the 2,221-favourite weekly set, opens on Mini Turret instead. Every one of the five leaves Heavy Barrage for last.
