---
title: "Yamato guide: charge the slash, then leave through the ultimate"
description: "Play Yamato as the assassin who picks a fight, heals through it and walks away invincible. When Power Slash is worth the charge time, why the current lists max Crimson Slash first, and how to survive the three heroes who beat her hardest."
hero: Yamato
heroSlug: yamato
heroId: 27
...
counters: [Seven, Graves, Victor, McGinnis, Kelvin]
synergyItems: [Refresher, Spirit Burn, Scourge, Escalating Exposure, Diviner's Kevlar]
buildIds: [275761, 323935, 202319, 1041, 1055]
sources:
  - https://dramalock.org/guides/yamato-deadlock-guide-build-abilities/
  - https://api.ranklock.app/heroes/27/matchups
  - https://api.ranklock.app/heroes/27/counters
  - https://api.ranklock.app/heroes/27/item-win-rates
heroImage: "https://assets-bucket.deadlock-api.com/assets-api-res/images/heroes/yamato_card.png"
liveHeroes: [Yamato, Graves, Seven, Sinclair]
liveItems: [Refresher, Spirit Burn, Scourge, Escalating Exposure, Diviner's Kevlar]
---

## Who plays Yamato, and why
...
## How to play Yamato as an Offensive initiator

Enter with Flying Slash and know your exit before you press it. The grapple pulls her onto an enemy for melee damage and a slow, which is an excellent way to reach the hero at the back and a terrible way to reach the hero in the middle, so pick the target on the edge and count the enemies who can turn around.
...
Max Crimson Slash first if you are learning her now. All three of her current lists open there, and the reason is the healing, since an ability that pays health for every hero it touches is what keeps a 730 HP assassin in a lane she cannot afford to lose.
...
The same three names lead both of her tables, and the counter endpoint is harsher than the matchup one. She wins 43.8% of 303,089 matches against Seven, 44.0% of 306,278 against Graves and 44.8% of 291,649 against Victor; among pairings with at least 20,000 games, those same three read 41.6% over 22,184 games for Graves, 42.6% over 20,420 for Victor and 42.8% over 20,066 for Seven. McGinnis at 45.6% over 162,270 and Kelvin at 46.2% over 132,782 finish the five.

All three beat her the same way, by breaking the charge. Power Slash needs sight and a moment, and heroes who can force an elevation change or a wall between you take both away, so against them charge from cover you can retreat into and open with Flying Slash on somebody who has already used their escape.

Draft her against heroes she can reach. She wins 54.8% of 123,748 games against Sinclair, 54.2% of 306,843 against Venator, 53.4% of 339,609 against Bebop, 53.1% of 321,308 against Mina and 53.0% of 210,534 against Paradox.

## Items that go well

Buy anti-heal and treat it as core. Scourge reads 57.1% across 597,380 games on her and Spirit Burn 57.0% across 1,185,003, the widest samples on her page, and both exist because a hero who wins fights by out-sustaining people loses to anyone who out-sustains her back.
