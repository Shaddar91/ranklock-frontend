---
title: "Grey Talon guide: survive the lane, own the long game"
description: "Play Grey Talon as the hero who is worst in the first half of the match and best in the second. What to level, how to hold a sightline, and the five heroes who close the distance on you."
hero: Grey Talon
heroSlug: grey-talon
heroId: 17
...
counters: [Seven, Victor, Graves, Kelvin, McGinnis, Bebop]
synergyItems: [Lucky Shot, Diviner's Kevlar, Spiritual Overflow, Mystic Reverb, Escalating Exposure]
buildIds: [465317, 267850, 371603, 1012, 234632]
sources:
  - https://dramalock.org/guides/grey-talon-deadlock-guide-build-abilities/
  - https://api.ranklock.app/heroes/17/matchups
  - https://api.ranklock.app/heroes/17/item-win-rates
heroImage: "https://assets-bucket.deadlock-api.com/assets-api-res/images/heroes/archer_card.png"
liveHeroes: [Grey Talon, Seven, Victor, Graves]
liveItems: [Lucky Shot, Diviner's Kevlar, Spiritual Overflow, Mystic Reverb, Escalating Exposure]
---
...
Guided Owl closes what the trap starts. The stun on detonation is the only reliable control in the kit that reaches across the map, so spend it on a target your team is already shooting.
...
Five heroes take the distance away from Grey Talon and the matchup table is not close about it. He wins 43.2% of 238,761 matches against Seven, 43.3% of 180,926 against Victor, 44.1% of 218,446 against Graves, 44.1% of 96,342 against Kelvin and 45.3% of 114,148 against McGinnis. Seven and Victor punish a stationary shooter, Graves and McGinnis fill the ground you want to stand on, and Kelvin cuts the retreat.

Against all five, move before you shoot. Hold Spirit Snare for the moment they close instead of using it as poke, and buy Diviner's Kevlar early. It wins 58.2% of the 56,750 games it appears in on the hero. Bebop is the one name the counter endpoint returns at all, at 49.9% over 23,769 games, and the fix there is positional: stand off the corner he can hook you around.

The lanes to press are Sinclair at 54.1% over 94,263 matches, Venator at 52.9% over 224,960, Mina at 52.5% over 218,577, Pocket at 52.0% over 137,219 and Silver at 51.9% over 166,839. None of those is a blowout, which is the honest read of the hero: he does not beat lanes, he outlives them.

## Items that go well

Lucky Shot at 59.3% over 174,764 games is the best-performing purchase on the hero and the one that suits a weapon fired in single, aimed shots. Mystic Reverb follows on the largest sample in his table, 56.0% over 1,622,920 games, and Escalating Exposure reads 55.3% over 234,873.

Watch the sample sizes at the top. Siphon Bullets shows 57.2% but over only 11,706 games, and Spellslinger 56.4% over 63,878. Both are thinner evidence than the win rate implies. Crippling Headshot at 55.6% over 158,948 games and Inhibitor at 55.6% over 33,130 are the two that answer a healing enemy team, and on a hero whose damage arrives one shot at a time, cutting the healing between shots is worth more than another point of Spirit.
