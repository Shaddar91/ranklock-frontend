...
counters: [Victor, Seven, Graves, Ivy, McGinnis]
synergyItems: [Spirit Burn, Frenzy, Mystic Reverb, Healing Tempo, Cheat Death]
buildIds: [516841, 359469, 529881, 1023, 211035]
sources:
  - https://dramalock.org/guides/haze-deadlock-guide-build-abilities/
  - https://ultimatemove.eu/en/deadlock-haze-guide-2026-how-to-actually-play-her/
  - https://api.ranklock.app/heroes/13/matchups
  - https://api.ranklock.app/heroes/13/item-win-rates
heroImage: /assets/heroes/haze_card.png
liveHeroes: [Haze, Victor, Seven, Graves]
liveItems: [Spirit Burn, Frenzy, Mystic Reverb, Healing Tempo, Cheat Death]
---
...
## How to play Haze as a Damage carry

Pick one target and stay on it. Fixation only pays if the same body keeps taking your bullets, so spreading fire across a fight throws away the mechanic you are built on, and switching targets to finish a low enemy is usually worse than killing the one you have stacked. Aim high while you do it, because the headshot rate is what makes the ramp feel fast.
...
Bullet Dance is the button people bring answers for, so check whether the enemy still holds theirs before you press it. A group that has already spent a stun is the group you ultimate into. The item that punishes theirs is Silencer, 60.6% across 3,628,841 games on the hero, the largest sample in her table by a wide margin.
...
Three heroes beat Haze in RankLock's own matches and all three do it by making the early game a fight instead of a farm. She wins 46.7% of 413,921 matches against Victor, 47.0% of 557,885 against Seven and 48.4% of 471,178 against Graves, and the counter endpoint sharpens the same three at Victor 43.4% over 31,675 games, Graves 44.7% over 37,145 and Ivy 46.5% over 26,651. Ivy sits at 48.6% over 310,651 matches in the matchup table and McGinnis at 49.1% over 244,834.

In those lanes, take the safe farm and refuse the trade. You are the hero on the wrong side of the clock at minute ten and the right side at minute forty, so every exchange you decline is one you win later. The lanes worth pressing are Sinclair at 58.3% over 189,710 matches, Venator at 56.3% over 525,582, Bebop at 55.8% over 504,437, Silver at 55.7% over 357,519 and Mina at 55.7% over 480,389.
