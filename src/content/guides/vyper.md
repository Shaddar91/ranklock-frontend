---
title: "Vyper guide: stick the dagger, then let the venom collect"
description: "Play Vyper as the slide-in assassin who kills people a second after she leaves. When Lethal Venom decides a trade, why Petrifying Bola is worth aiming, and how to survive a start that loses more than it wins."
hero: Vyper
heroSlug: vyper
heroId: 58
...
counters: [Graves, Seven, Victor, McGinnis, Kelvin, Wraith]
synergyItems: [Frenzy, Spellslinger, Lucky Shot, Silencer, Glass Cannon]
buildIds: [376014, 456428, 260011, 196233, 432841]
sources:
  - https://dramalock.org/guides/vyper-deadlock-guide-build-abilities/
  - https://deadlock.io/en/heroes/vyper
  - https://api.ranklock.app/heroes/58/matchups
  - https://api.ranklock.app/heroes/58/counters
  - https://api.ranklock.app/heroes/58/item-win-rates
heroImage: "https://assets-bucket.deadlock-api.com/assets-api-res/images/heroes/kali_card.png"
liveHeroes: [Vyper, Graves, Seven, Sinclair]
liveItems: [Frenzy, Spellslinger, Lucky Shot, Silencer, Glass Cannon]
---

## Who plays Vyper, and why

Play Vyper if you are willing to lose the first twenty minutes to own the last twenty. She wins 46.2% of matches settled under 30 minutes, 49.4% of those running 30 to 45 and 50.1% past 45, a climb of 4.0 points and the whole argument for playing her. The early game is something she survives; the late game is where the items she has been saving for turn every slide into a kill.

Respect the stamina bar more than the health bar. She carries 780 HP at 6.9 m/s, which is slow, on 4 stamina, which is not, and the stamina is the point, because her damage happens where she can slide in and back out, and a Vyper standing still is a Vyper trading her worst statistic against somebody else's best.
...
Farm for the expensive slots and refuse the fights that stop you reaching them. Split Shot appears in her builds 11.4 times more often than the roster average and Armor Piercing Rounds 4.9 times, and the second is a late tier-four purchase, so a Vyper who spent the mid game dying to skirmishes never gets to the version of herself the win rate describes.

## How to play Vyper as an Offensive initiator
...
Open with points in Screwjab Dagger. Three of her five lists open there, and it is the point that makes the lane work: the dagger is her only early way to hold one hero still long enough to shoot them.

Take Lethal Venom second in most games. Three of the five put it second and one puts it first outright, and the reason to move it up is a lane where the enemy keeps stepping back to heal, since the venom follows them and the dagger does not. Slither is the point you take when the lane is safe and the map is not.

Petrifying Bola goes last on four of the five lists, and it should go last for you. The ultimate is a single decision each fight, and a fifth point in the abilities you press constantly is worth more than an earlier one in the button you press once.
