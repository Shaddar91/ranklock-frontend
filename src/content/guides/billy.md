---
title: "Billy guide: survive the lane, then never let anyone leave"
description: "Play Billy as the hero who is worst in the first 30 minutes and best after. How to trade in lane, when Chain Gang actually holds, and the melee purchases that separate him from everyone else."
hero: Billy
heroSlug: billy
heroId: 72
...
synergyItems: [Frenzy, Arctic Blast, Silencer, Colossus, Phantom Strike]
buildIds: [543610, 291077, 332119]
sources:
  - https://dramalock.org/guides/billy-deadlock-guide-build-abilities/
  - https://urgametips.com/deadlock-billy-guide/
  - https://api.ranklock.app/heroes/72/matchups
  - https://api.ranklock.app/heroes/72/item-win-rates
heroImage: "https://assets-bucket.deadlock-api.com/assets-api-res/images/heroes/punkgoat_card.png"
liveHeroes: [Billy, Seven, Graves, Victor]
liveItems: [Frenzy, Arctic Blast, Silencer, Colossus, Phantom Strike]
---
...
Melee and shoot in the same exchange, then repeat. Blasted refills your ammunition from melee hits, so a Billy who punches, empties the magazine into a wrecked target and punches again never has to break contact to reload. That loop is what the signature purchases are buying. Crushing Fists appears on him 9.5 times more often than across the field and Melee Charge 7.0 times, and no two purchases mark a Billy build more clearly.

The gun half of the build then does the scaling. Frenzy wins 59.8% of the 627,093 Billy games it appears in and Silencer 57.8% of 498,556, and both reward the long, committed fight the melee loop creates. Siphon Bullets at 55.7% over 569,134 games and Phantom Strike at 55.9% over 642,046 close the gap to whoever tried to walk away.
...
Frenzy and Silencer first once the game is past its opening, then Arctic Blast at 58.0% over 271,780 games when you need the slow to hold someone in the chain. Scourge wins 56.6% of 2,507,910 Billy games and Escalating Exposure 55.9% of 35,990, and Diviner's Kevlar at 56.1% over 67,210 covers a team whose damage arrives as spirit.

His allies are worth less to him than his items. Billy wins 50.3% of the 20,039 games he shares with Vindicta, 47.8% of the 21,869 with Infernus and 47.8% of the 26,856 with Drifter, so no pairing rescues a bad early game. Play the curve instead and let the match run long.
