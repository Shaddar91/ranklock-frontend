---
title: "Silver guide: win the mid game or hand it to somebody else"
description: "Play Silver as two heroes on one clock. When to spend Entangling Bola, why the rifle form is the one that farms, and how a hero who loses the first thirty minutes still climbs four points by the end."
hero: Silver
heroSlug: silver
heroId: 80
...
roles: [damage, tank, offensive]
counters: [Graves, Seven, Victor, Celeste, Lash, Ivy]
synergyItems: [Silencer, Frenzy, Lucky Shot, Phantom Strike, Inhibitor]
buildIds: [440921, 419429, 479334, 442277, 442356]
sources:
  - https://dramalock.org/guides/silver-deadlock-guide-build-abilities/
  - https://deadlock.io/en/heroes/silver
  - https://api.ranklock.app/heroes/80/matchups
  - https://api.ranklock.app/heroes/80/counters
  - https://api.ranklock.app/heroes/80/item-win-rates
heroImage: "https://assets-bucket.deadlock-api.com/assets-api-res/images/heroes/werewolf_card.png"
liveHeroes: [Silver, Graves, Seven, Victor]
liveItems: [Silencer, Frenzy, Lucky Shot, Phantom Strike, Inhibitor]
---
...
Stand in the fight when Bloodlust is close, and get out of it when it is not. The werewolf form heals her while she fights, so the transform is the only window in which trading damage face to face is the correct play, and everything before it is positioning.

Lifestrike goes into her builds 5.8 times more often than the roster average and Hunter's Aura 5.5 times, which tells you what her players actually buy: sustain that pays out while she is swinging, plus a lane-wide damage aura she can hold ground behind. Both are early purchases, and both are worth more to her than a raw resistance stack that does nothing between fights.

Do not confuse durability with immobility. On 2 stamina she cannot dash out of a mistake twice, so the front she holds has to be one her team is already fighting for, near an objective and near a way home.
...
Graves is the loss. Silver wins 36.8% of 20,033 games against him in the counter table and 40.2% of 304,078 in the wider sample, the worst pairing on either list. Seven follows at 40.3% over 332,162 games and Victor at 41.7% over 308,219.

Each of the three punishes a hero who has to walk to her damage. Take the safer lane, farm through the early window the curve already says you lose, and refuse the fight until the transform is close. Celeste at 42.8% over 22,425 games and Lash at 43.7% over 21,200 are the two other rows the counter table clears its 20,000-game floor for, and both catch her mid-approach.

Look at the other end before you write the pick off. Ivy at 43.6% over 201,407 games and McGinnis at 43.4% over 159,320 finish the five worst, but she takes 52.2% of 127,918 games against Sinclair, 50.9% of 336,551 against Venator, 50.2% of 308,928 against Bebop, 50.2% of 317,508 against Mina and 50.0% of 158,500 against Mirage.
