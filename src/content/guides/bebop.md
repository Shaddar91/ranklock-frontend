---
title: "Bebop guide: land the hook, bank the bomb, win the fight"
description: "Play Bebop as the hero whose whole game is one pull and one bomb. Where to hook from, why Sticky Bomb has to hit heroes, and how to survive the three lanes that break him."
hero: Bebop
heroSlug: bebop
heroId: 15
...
counters: [Seven, Victor, Graves, Kelvin, Ivy]
synergyItems: [Spellslinger, Frenzy, Lucky Shot, Diviner's Kevlar, Colossus]
buildIds: [433490, 334667, 369057, 1084]
sources:
  - https://dramalock.org/guides/bebop-deadlock-guide-build-abilities/
  - https://api.ranklock.app/heroes/15/matchups
  - https://api.ranklock.app/heroes/15/item-win-rates
heroImage: /assets/heroes/bebop_card.png
liveHeroes: [Bebop, Seven, Victor, Ivy]
liveItems: [Spellslinger, Frenzy, Lucky Shot, Diviner's Kevlar, Colossus]
---

## Who plays Bebop, and why

Play Bebop if you are willing to be judged on one button. Grapple Arm reels in the first character it touches, and the whole match bends around whether you hit it, from which angle, and on whom. He has the health to be wrong occasionally, 880 HP and 6.45 m/s, and a win rate that barely moves with match length: 49.1% under 30 minutes, 46.4% from 30 to 45, 49.2% past 45. Nothing about him improves by waiting, so play for the pull you can get now.

The rest of the kit exists to punish whoever you dragged. Exploding Uppercut knocks a target up and leaves a patch that damages and slows what lands nearby. Sticky Bomb detonates on a delay and banks permanent bonus damage every time it is stuck to a hero. Hyper Beam is a channelled beam that does spirit damage and slows, and it is the reason cover matters as much to you as aim.

## How to play Bebop as an Offensive initiator
...
Bebop loses hardest in the games where nobody ever has to walk into hook range. He wins 40.7% of 450,179 matches against Seven, 41.1% of 342,161 against Victor, 42.4% of 434,719 against Graves, 42.9% of 203,805 against Kelvin and 42.9% of 302,793 against Ivy. The counter endpoint agrees on the shape and reorders the top: Victor at 40.7% over 28,180 games, Ivy at 41.1% over 31,318, Graves at 41.7% over 44,707.

Against all five the answer is the same and it is unglamorous. Stop hunting for the hook in open ground, farm the safe half of the lane, and only commit once the enemy has spent the ability that punishes a channel. Your best rows are Sinclair at 51.8% over 197,927 matches, Venator at 51.0% over 472,130, Mina at 49.9% over 424,645, Silver at 49.8% over 308,928 and Pocket at 49.2% over 268,094, and even those are close to even, which is the honest summary of the hero.
